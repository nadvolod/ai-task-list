    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-lg mx-auto px-4 py-4">
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 space-y-4">
          ...
          <div>
            <label htmlFor="new-task-notes" className="block text-sm font-medium text-gray-700 mb-1">Notes (optional)</label>
            <textarea
              id="new-task-notes"
              rows={3}
              value={description}
          ...
          <div>
            <label htmlFor="new-task-due" className="block text-sm font-medium text-gray-700 mb-1">Due date (optional)</label>
            <input
              id="new-task-due"
              type="date"
              value={dueDate}
